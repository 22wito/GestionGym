...
public class ErrorDesconocido extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ErrorDesconocido frame = new ErrorDesconocido();
	...
	public ErrorDesconocido() {
		...
		JLabel lblAforo = new JLabel("ERROR DESCONOCIDO");
